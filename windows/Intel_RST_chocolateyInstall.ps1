...
$setupFile = Join-Path "$unpackDir" "\IRST_Win7-81-10_64bit_V14801042\IRST\Driver\Disk\AsusSetup.exe"
$setupFile2 = Join-Path "$unpackDir" "\IRST_Win7-81-10_64bit_V14801042\IRST\Install\AsusSetup.exe"
$checksumtype = 'sha256'

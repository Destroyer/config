...
# Modified with additional functions from https://github.com/Sycnex/Windows10Debloater/ and https://github.com/W4RH4WK/Debloat-Windows-10
# Based on version: v2.13, 2018-03-18
...
Function HideSyncNotifications {
	...
	Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced" -Name "ShowSyncProviderNotifications" -Type DWord -Value 0
}
